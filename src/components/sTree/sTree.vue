<template>
	<Tree :data="data" @on-check-change="handleCheckSelect" v-on="parent.$listeners" v-bind="parent.$attrs" 
		:load-data="loadDataCallback" :show-checkbox="checkbox" :check-strictly="false"></Tree>
</template>
